-- Smart Plan voice is 100 minutes/month, not 6000 (legacy "100 hours" mistake).
UPDATE public.admin_config
  SET value = '100', updated_at = now()
  WHERE key = 'smart_plan_voice_minutes_monthly';

-- Trial voice RPC: user-facing errors must say 100 minutes/month, not 100 hours.
