...
const FEATURES: FeatureCard[] = [
  ...
  },
  {
    ...
    tagline: "Talk. Snap. Type. The plan gets in — your way, every time.",
    bullets: [
      "Dictate your plan out loud and the app parses it into tasks. Takes 90 seconds.",
      "Photograph your handwritten timetable and it reads your own handwriting.",
      "Prefer typing? Self Type puts you in full control. All three are yours on Pro.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Use the study camera to stay accountable — your phone sees you showing up.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Pro and Pro Max unlock 20–50 photo scans and 40–80 voice minutes per month.",
    ],
  ...
  },
  {
    id: "ai-capture",
    emoji: "🎁",
    title: "AI Capture Tools",
    tagline: "Your handwritten notes, your voice, your ideas — all in the app in seconds, not minutes.",
    bullets: [
      "Photograph a handwritten plan or page of notes and the AI reads it for you.",
      "Talk out your day in one breath — voice dictation turns speech into a structured task list.",
      "Basic trial includes 3 photo scans + 2 voice minutes so you feel it before you commit.",
    ],
