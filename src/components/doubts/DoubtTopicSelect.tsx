  ...
  return (
    <div className={clsx("block", className)}>
      ...
      <select
        ...
        className="mt-1.5 min-h-[48px] w-full appearance-none rounded-xl border border-kal-border bg-kal-input-bg px-3 py-3 pr-10 text-[15px] text-kal-text outline-none focus-visible:ring-2 focus-visible:ring-kal-accent/40 disabled:opacity-50 dark:bg-kal-input-bg"
        style={{
