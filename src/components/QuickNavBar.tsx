            ...
            {items.map((item) => {
              ...
              return (
                <Link
                  ...
                  title={item.label}
                  className={clsx(
                    "inline-flex size-8 shrink-0 items-center justify-center rounded-full border backdrop-blur-md transition-colors sm:h-9 sm:w-9",
                    active
                ...
                >
                  <Icon className="size-3 sm:h-3.5 sm:w-3.5" strokeWidth={2} aria-hidden />
                </Link>
              );
            })}
          </div>
