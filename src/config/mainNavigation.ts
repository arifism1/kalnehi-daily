...
export const MAIN_NAV_SECTIONS: MainNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/study-sessions", label: "Study Sessions", shortLabel: "Study", Icon: Video },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/revision", label: "Revision Engine", shortLabel: "Revision", Icon: RotateCcw },
  ...
  },
  {
    ...
    items: [
      { href: "/habits", label: "Habit Maker", shortLabel: "Habits", Icon: ListChecks },
      {
        href: "/motivation",
      ...
      { href: "/doubts", label: "Doubt Tracker", shortLabel: "Doubts", Icon: CircleHelp },
    ],
  },
  {
    title: "Account & Legal",
