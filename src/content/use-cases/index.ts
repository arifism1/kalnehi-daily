...
const jeeDroppers: UseCaseData = {
  ...
  dayInTheLife: [
    ...
    { time: "6:30 AM", activity: "PrepBrain AI morning briefing", kalnehiRole: "Ask PrepBrain what to prioritize today based on your mock performance and coverage gaps" },
    ...
    { time: "10:15 AM", activity: "Revision slot — Inorganic Chemistry (yesterday's topics)", kalnehiRole: "Spaced Revision Engine auto-added this slot based on when you last studied it" },
    ...
    { time: "4:30 PM", activity: "Mock test analysis", kalnehiRole: "Marks Engine — log scores, identify topic-wise weak areas, get PrepBrain recommendations" },
  ...
  features: [
    { title: "PrepBrain AI", why: "In a drop year, you need someone to tell you what to prioritize today, this week, and this month — not generic advice. PrepBrain understands your JEE syllabus coverage and mock performance." },
    ...
    { title: "Spaced Revision Engine", why: "You studied Rotational Motion three months ago. Without scheduled revision, you'll forget 70% of it before the exam. The engine makes sure you don't." },
  ...
  faqs: [
    ...
    { q: "What's the first thing a dropper should do in Kalnehi?", a: "Set up your JEE syllabus in the Syllabus Tracker and log your last JEE rank or mock score in the Marks Engine. This gives PrepBrain AI enough context to give useful advice from day one." },
    { q: "How should revision be structured in a drop year?", a: "Class 11 topics need at least 2-3 revision cycles before the exam. Class 12 topics need coverage first, then revision. Kalnehi's Spaced Revision Engine auto-schedules this based on when you studied each topic." },
...
const neetDroppers: UseCaseData = {
  ...
  dayInTheLife: [
    ...
    { time: "6:00 – 9:00 AM", activity: "Biology — Genetics and Evolution", kalnehiRole: "Syllabus Tracker updated. Spaced revision of Diversity of Life (studied 7 days ago)" },
    { time: "9:15 AM", activity: "PrepBrain check-in", kalnehiRole: "Ask PrepBrain: which Chemistry chapters have I not revised in 2+ weeks?" },
    ...
    { time: "9:00 PM", activity: "Tomorrow's plan", kalnehiRole: "Daily Planner — PrepBrain suggests what to cover based on gaps" },
  ],
  features: [
    ...
    { title: "PrepBrain AI", why: "PrepBrain understands NEET's chapter-wise weightage and can tell you what to prioritize when time is short — based on your actual coverage, not generic advice." },
    { title: "Spaced Revision Engine", why: "NEET NCERT revision is the exam. Students who revise Biology NCERT 5+ times consistently outperform those who read it more times without tracking." },
  ...
  faqs: [
    { q: "How many NEET revisions are enough?", a: "Physics and Chemistry need 3-4 thorough revisions. Biology NCERT needs 5-7 revisions for most students to reach retention levels required for NEET accuracy. The Spaced Revision Engine ensures you're doing these at the right intervals." },
    { q: "Should a NEET dropper join coaching again?", a: "This depends on specific gaps. If conceptual understanding is the issue, coaching helps. If it's about coverage and revision, a strong self-study system can be more effective. PrepBrain AI can help identify which gap is yours." },
...
const class11Students: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "6:00 AM", activity: "30-minute revision before school", kalnehiRole: "Spaced Revision Engine — quick review of yesterday's coaching content" },
    ...
    { time: "9:00 PM", activity: "Daily log and tomorrow planning", kalnehiRole: "5-minute log. PrepBrain suggests if revision should be added tomorrow." },
  ],
  features: [
    ...
    { title: "PrepBrain AI", why: "When you're starting out, knowing what to prioritize and how to approach each subject for JEE/NEET specifically is more valuable than generic study tips." },
...
const class12Students: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "5:30 AM", activity: "Board exam prep — revision of yesterday's chapter", kalnehiRole: "Spaced Revision Engine — board chapters scheduled alongside JEE/NEET topics" },
    ...
    { time: "7:00 – 9:30 PM", activity: "JEE/NEET self-study — problem solving", kalnehiRole: "Study Timer. PrepBrain suggests whether to focus on board-heavy or entrance-heavy topics today." },
    { time: "9:30 PM", activity: "Log + next day plan", kalnehiRole: "Daily Planner — PrepBrain balances boards vs entrance for tomorrow" },
  ],
  features: [
    { title: "PrepBrain AI", why: "The unique value in Class 12 is AI that understands both boards and entrance exams and can tell you when to prioritize which — especially in the critical months before board exams." },
    ...
    { title: "Spaced Revision Engine", why: "Class 11 topics studied months ago need revision before entrance exams. The engine ensures these don't fall through the cracks during the Class 12 crunch." },
  ...
  faqs: [
    { q: "How do I balance boards and JEE/NEET in Class 12?", a: "Focus on overlapping topics first — they give you gains in both. For board-only topics, cover them systematically in the months before board exams. Use PrepBrain AI to get specific advice based on your current coverage and upcoming dates." },
    ...
    { q: "What should I do after board exams are over?", a: "Full switch to entrance exam mode. Use the Syllabus Tracker to identify which topics haven't been touched since Class 11 and attack them first. PrepBrain AI can generate a specific revision plan for this period." },
  ],
...
const upscWorkingProfessionals: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "5:30 – 7:00 AM", activity: "Morning study session — UPSC reading or revision", kalnehiRole: "PrepBrain suggests what to cover based on coverage gaps. Study Timer for focused sessions." },
    ...
    { time: "9:30 PM", activity: "Daily log", kalnehiRole: "30-second log. PrepBrain adjusts tomorrow's suggestion if today was cut short." },
    { time: "Weekend", activity: "Deep dives — History, Polity, Geography", kalnehiRole: "Syllabus Tracker to identify least-covered areas. Spaced Revision Engine for revision." },
  ],
  features: [
    { title: "PrepBrain AI", why: "For working professionals, PrepBrain AI's ability to give specific, prioritized advice — 'you have 3 hours today, cover these two Polity chapters' — is the most valuable feature." },
  ...
  faqs: [
    ...
    { q: "How do I handle current affairs with limited time?", a: "Daily 30-45 minutes of structured current affairs reading (one good source) is more effective than 2 hours of scattered reading. PrepBrain AI can help you identify the high-priority themes to track." },
...
const caStudents: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "5:30 – 7:00 AM", activity: "Law or SFM revision before articleship", kalnehiRole: "Spaced Revision Engine — scheduled revision appears automatically" },
    ...
    { time: "8:00 – 10:30 PM", activity: "Evening study session — Accounts or Taxation", kalnehiRole: "Study Timer. Syllabus Tracker updated. PrepBrain prioritizes based on exam date proximity." },
  ...
  features: [
    ...
    { title: "Spaced Revision Engine", why: "Law and accounting standards require multiple revisions at the right intervals. The engine ensures sections studied in January are reviewed before May/November exams without manual tracking." },
    { title: "PrepBrain AI", why: "PrepBrain understands CA examination structure and can give specific advice — which standards to prioritize, how much time Accounts needs vs Law — based on your coverage and exam date." },
  ...
  faqs: [
    { q: "How should I manage CA Intermediate preparation during articleship?", a: "Morning sessions (5:30-7:30 AM) for revision of previous day's material, evening sessions (8-11 PM) for new content, and weekend deep dives for harder subjects. PrepBrain AI can help you allocate time across subjects based on which exam group is sooner." },
    { q: "How many revisions does CA Inter need?", a: "Accounts and Law need at least 3-4 thorough revisions before the exam. The Spaced Revision Engine auto-schedules these. SFM and Taxation need problem-solving practice alongside reading." },
    { q: "Can Kalnehi track ICAI amendments?", a: "The Syllabus Tracker lets you mark topics as 'current' or 'amended' so you know which sections need refreshing. PrepBrain AI can remind you to check for amendments before exams." },
  ],
...
const engineeringStudentsGate: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "6:00 – 8:00 AM", activity: "GATE subject study — core concepts", kalnehiRole: "Syllabus Tracker. PrepBrain suggests which subjects have the highest weightage gap." },
    ...
    { time: "8:30 PM", activity: "Daily log + next day planning", kalnehiRole: "PrepBrain adjusts tomorrow based on how placements or project disrupted today" },
  ],
  features: [
    ...
    { title: "PrepBrain AI", why: "PrepBrain understands GATE subject weightages and can tell you to spend more time on TOC and OS than on less-weighted subjects — critical advice when preparation time is limited." },
  ...
  faqs: [
    ...
    { q: "How to manage GATE prep alongside placements?", a: "GATE and placements have different skill requirements but significant overlap in CS fundamentals. Treat November-December as a dual preparation period. After placements conclude, shift focus fully to GATE. PrepBrain can help you navigate this." },
