...
const jeeDroppers: UseCaseData = {
  ...
  dayInTheLife: [
    ...
    { time: "10:15 AM", activity: "Revision slot — Inorganic Chemistry (yesterday's topics)", kalnehiRole: "Revision Reminders showed this topic as due; you added it to today's plan" },
  ...
  features: [
    ...
    { title: "Revision reminders", why: "You studied Rotational Motion three months ago. Without dated follow-ups, you'll forget most of it before the exam. A visible due list makes the next review unavoidable." },
...
const neetDroppers: UseCaseData = {
  ...
  dayInTheLife: [
    ...
    { time: "6:00 – 9:00 AM", activity: "Biology — Genetics and Evolution", kalnehiRole: "Syllabus Tracker updated. Diversity of Life due for review (set in Revision Reminders)" },
  ...
  features: [
    ...
    { title: "Revision reminders", why: "NEET NCERT revision is the exam. Students who revise Biology NCERT 5+ times consistently outperform those who read it more times without tracking." },
  ...
  faqs: [
    { q: "How many NEET revisions are enough?", a: "Physics and Chemistry need 3-4 thorough revisions. Biology NCERT needs 5-7 revisions for most students to reach retention levels required for NEET accuracy. Revision Reminders help you stick to those intervals with clear due dates." },
...
const class11Students: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "6:00 AM", activity: "30-minute revision before school", kalnehiRole: "Revision Reminders — quick review of topics you marked due" },
...
const class12Students: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "5:30 AM", activity: "Board exam prep — revision of yesterday's chapter", kalnehiRole: "Revision Reminders — board and entrance topics in one due list" },
  ...
  features: [
    ...
    { title: "Revision reminders", why: "Class 11 topics studied months ago need revision before entrance exams. A dated queue keeps them visible during the Class 12 crunch." },
...
const upscWorkingProfessionals: UseCaseData = {
  ...
  dayInTheLife: [
    ...
    { time: "Weekend", activity: "Deep dives — History, Polity, Geography", kalnehiRole: "Syllabus Tracker to identify least-covered areas. Revision Reminders for what's due next." },
  ],
  features: [
...
const caStudents: UseCaseData = {
  ...
  dayInTheLife: [
    { time: "5:30 – 7:00 AM", activity: "Law or SFM revision before articleship", kalnehiRole: "Revision Reminders — due items surface before you open the planner" },
  ...
  features: [
    ...
    { title: "Revision reminders", why: "Law and accounting standards require multiple revisions at the right intervals. Dated reminders help you revisit January sections before May/November attempts without relying on memory." },
