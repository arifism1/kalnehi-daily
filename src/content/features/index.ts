...
Mastermind can analyse your mock test performance and identify which subject or topic area is consistently pulling your aggregate down. It can tell you whether you're spending proportional time across subjects. It can plan your final revision month chapter by chapter.
...
This is not AI for the sake of AI. Mastermind exists because the single hardest problem in exam preparation is knowing what to study right now — not in general, but today, at your current level, with your specific exam date. Mastermind answers that question every single day.`,
    ...
    examCompatibility: "Mastermind works for all supported exams — JEE, NEET, UPSC, CAT, GATE, CA, SSC, Banking, CLAT and more. It adapts its strategy advice based on your specific exam context.",
    ...
    faqs: [
      ...
      { question: "How many Mastermind queries do I get?", answer: "Smart Plan includes 20 lakh (2 million) Mastermind tokens per month. Your monthly pool refreshes on the same calendar date each month as when your subscription started (not necessarily the 1st). The 3-day free trial includes 60,000 tokens for the entire trial period." },
    ...
    metaDescription: "Mastermind reads your syllabus completion, mock scores and study logs to give personalised exam strategy advice. Not a chatbot — a data-driven study coach for JEE, NEET, UPSC and more.",
  },
  {
    slug: "voice-control",
    name: "Voice Control",
...
For aspirants who study in deep focus states, voice control preserves that state. For those who study in libraries or quiet environments, voice commands can be whispered. For those using Kalnehi Daily during commutes, voice control makes logging possible while moving.`,
    ...
    faqs: [
      ...
      { question: "How many minutes of voice control do I get?", answer: "Smart Plan includes 100 minutes of voice control per month. Included minutes refresh on the same calendar date each month as when your subscription started. The 3-day free trial includes 5 minutes of voice for the entire trial period." },
    ...
    metaDescription: "Hey Boss voice control lets you log study sessions, mark chapters, set reminders and ask Mastermind — all hands-free. Built for JEE, NEET, UPSC and all competitive exam aspirants.",
  },
  {
...
The engine also shows your Target Score Blueprint: given your target college or rank, which chapters should you prioritise based on their marks contribution? This turns a vague target ("I want to crack JEE") into a specific chapter priority list.`,
    scenarios: [
      ...
      "A NEET aspirant's scores show Biology declining month-on-month. Mastermind analyses the mock data and identifies: 'Your Ecology and Genetics scores dropped 15% over the last 3 tests. These are revision items — not new learning gaps.' It schedules focused Ecology and Genetics revision this week.",
      "An SSC CGL aspirant uses the Marks Engine to track sectional scores across 20 mocks. The engine shows Quantitative Aptitude is consistently 3-4 marks below their personal target. Mastermind identifies the 5 QA topics with the most wrong answers and builds a targeted practice plan.",
    ],
    ...
    faqs: [
      ...
      { question: "Can I track marks for all my subjects separately?", answer: "Yes. Log sectional scores for each section of your exam — Physics/Chemistry/Maths for JEE, or QA/DILR/VARC for CAT. The engine tracks each section separately and Mastermind analyses patterns at the section level." },
...
For long-exam preps like UPSC (12-18 months) and CA (multiple-year journey), the heatmap becomes a visual record of your entire preparation. Toppers look back at months of dense green heatmaps. Failures have obvious grey patches. The heatmap predicts outcomes before exams do.`,
    scenarios: [
      "A UPSC aspirant reviews their heatmap after 6 months of preparation. They see a 3-week grey patch in March. Mastermind reads the heatmap and says: 'Your output dropped significantly in March. Your exam is in 4 months and you're 18% behind your projected completion. Here's a recovery plan.'",
      ...
      "A NEET aspirant's heatmap shows that Sundays are consistently grey (no study). Mastermind identifies this pattern and suggests building a lighter Sunday routine — even 2 hours — to eliminate the pattern before it becomes a habit.",
    ],
...
Mastermind reads your doubt tracker and identifies patterns — if you have 12 doubts tagged under Organic Chemistry Mechanisms, Mastermind flags this as a systematic gap, not individual questions. It then recommends targeted practice for that specific area.
...
Students who resolve their doubts systematically consistently outperform those who let questions accumulate. The doubt tracker makes the difference visible.`,
    scenarios: [
      ...
      "Mastermind reads a NEET aspirant's doubt tracker and flags: 'You have 15 doubts in Genetics and 11 in Molecular Biology. This is a systematic gap — not random. You need 3 focused hours on the Central Dogma and Mendelian ratios to clear this cluster.'",
    ],
...
Each habit has its own streak counter. Breaking a habit streak is logged and visible. Mastermind reads your habit completion data and factors it into its strategy — a student who has been meditating daily for 30 days has better cognitive baseline than one who hasn't.`,
    scenarios: [
      ...
      "A NEET aspirant sets up a daily 'Biology diagram practice' habit for 20 minutes every morning. Mastermind reads the 60-day streak and notes: 'You've maintained daily Biology diagram practice for 2 months. This is likely why your Biology visual question accuracy has improved 18% in the last 3 mocks.'",
    ],
    ...
    faqs: [
      { question: "How many habits can I create?", answer: "No fixed limit. However, Mastermind will flag if you have more than 8-10 active habits — too many habits reduce completion rates and create guilt rather than momentum." },
...
Over months, the daily log becomes your most honest preparation data. You can search back to any date, review what you covered, and use it to avoid repeating past mistakes.`,
    scenarios: [
      ...
      "After a disappointing JEE mock score, a JEE aspirant reads their daily logs for the past 2 weeks. They notice they logged 'distracted, couldn't concentrate' on 6 out of 14 days — a pattern Mastermind flags as study environment or sleep quality issue.",
