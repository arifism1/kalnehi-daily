...
For aspirants who study in deep focus states, voice control preserves that state. For those who study in libraries or quiet environments, voice commands can be whispered. For those using Kalnehi Daily during commutes, voice control makes logging possible while moving.`,
    ...
    faqs: [
      ...
      { question: "How many minutes of voice control do I get?", answer: "Smart Plan includes 100 minutes of voice control per month. Included minutes refresh on the same calendar date each month as when your subscription started. The 7-day free trial includes 5 minutes of voice for the entire trial period." },
