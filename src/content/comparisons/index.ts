...
const notion: ComparisonData = {
  ...
  rows: [
    ...
    { feature: "Spaced repetition auto-scheduling", kalnehi: "yes", competitor: "no" },
  ...
  whyKalnehi: [
    ...
    "Kalnehi has the exam workflow built in. Your JEE/NEET/UPSC syllabus is already there. Your daily planner knows what revision is due. PrepBrain AI understands your syllabus context.",
...
const googleCalendar: ComparisonData = {
  ...
  rows: [
    ...
    { feature: "Spaced repetition scheduling", kalnehi: "yes", competitor: "no" },
  ...
  whyKalnehi: [
    ...
    "Revision scheduling in Google Calendar is manual — you have to create repeat events for every topic. Kalnehi's Spaced Revision Engine auto-schedules based on what you've studied and when.",
...
const physicalTimetable: ComparisonData = {
  ...
  rows: [
    ...
    { feature: "Auto-schedules revision", kalnehi: "yes", competitor: "no" },
  ...
  whyKalnehi: [
    ...
    "Spaced revision cannot be scheduled manually across 100+ topics without errors. Kalnehi's engine tracks exactly when each topic needs to be reviewed.",
...
const excelStudyPlanner: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Revision scheduling in a spreadsheet is either manual or requires complex formulas. Kalnehi's Spaced Revision Engine does this automatically based on what you've actually studied.",
...
const todoist: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Spaced revision cannot be managed via recurring Todoist tasks alone — you'd need to manually create, track, and reschedule hundreds of revision reminders. Kalnehi automates all of this.",
