...
const notion: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Kalnehi Daily has the exam workflow built in. Your JEE/NEET/UPSC syllabus is already there. Revision Reminders keeps your next review dates in one place. Mastermind understands your syllabus context.",
...
const googleCalendar: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Revision scheduling in Google Calendar is manual — you have to create repeat events for every topic. Kalnehi Daily's Revision Reminders gives you a single due list with dates you control, next to your syllabus and daily plan.",
...
const physicalTimetable: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Spaced revision across 100+ topics needs a system, not memory. Kalnehi Daily's Revision Reminders keeps every topic's next due date in one sortable list.",
...
const excelStudyPlanner: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Revision scheduling in a spreadsheet is either manual or requires complex formulas. Kalnehi Daily's Revision Reminders gives you a first-class due list without building a grid yourself.",
...
const todoist: ComparisonData = {
  ...
  whyKalnehi: [
    ...
    "Spaced revision cannot be managed via recurring Todoist tasks alone — you'd need to manually create, track, and reschedule hundreds of tasks. Kalnehi Daily's Revision Reminders is built for that workload in one list.",
