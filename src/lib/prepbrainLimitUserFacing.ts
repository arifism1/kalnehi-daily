...
const PREPBRAIN_LIMIT_MESSAGE_MONTHLY_UI =
  "You have reached your monthly AI limit of 2 million tokens (Mastermind). It will reset on the 1st of next month.";

const PREPBRAIN_LIMIT_MESSAGE_WELCOME_UI =
  "You've used all 60,000 Mastermind tokens in your 3-day free trial. Upgrade to Smart Plan (₹399/month) for 2 million tokens every month.";
