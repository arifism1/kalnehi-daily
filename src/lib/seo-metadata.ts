...
> = {
  ...
  backlogTracker: {
    path: "/backlog-tracker",
    title: `Backlog Tracker — voice-first recovery | ${SITE_NAME}`,
    description: `Vent what’s pending; turn it into a calm daily plan starting tomorrow in ${SITE_NAME}.`,
  },
};
