...
> = {
  ...
  backlogs: {
    path: "/backlogs",
    title: `Backlogs — syllabus recovery & scheduling | ${SITE_NAME}`,
    description: `Review planned and unplanned backlog, capture items by voice or text, and schedule them into your daily plan in ${SITE_NAME}.`,
  },
};
