      ...
      <article className="space-y-10">
        ...
        <section className="space-y-3" aria-labelledby="neetpg-system">
          ...
          <ul className="space-y-3 text-sm">
            {[
              ...
              { t: "High-yield topic prioritisation", d: "Mastermind flags the NEET PG high-yield subjects (Medicine, Surgery, OBG, Paediatrics) and ensures you're giving them proportional preparation time relative to their marks weight." },
              { t: "Grand test planning", d: "Log your NEET PG grand test scores and Mastermind tracks your percentile trend. It tells you which subject is consistently pulling your rank down and what to focus on before the next test." },
        ...
        <section className="space-y-2">
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li><Link href="/features/prepbrain-ai" className="font-medium text-kal-accent-dark hover:underline">Mastermind — your personal study strategist →</Link></li>
          </ul>
        </section>
