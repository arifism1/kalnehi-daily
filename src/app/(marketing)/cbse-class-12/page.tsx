...
export const metadata = marketingPageMetadata({
  ...
  description: `Class 12 Boards determine college admissions, CUET eligibility and confidence. Kalnehi Daily helps you balance Boards prep with JEE/NEET/CUET preparation without burning out.`,
});

const FAQS = [
  { question: "How do I balance Class 12 Boards with JEE/NEET simultaneously?", answer: "The key is to treat Boards and entrance prep as complementary, not competing. NCERT forms the base for both. Kalnehi Daily lets you set up separate syllabuses for Boards and your entrance exam, and plan daily time blocks for each. Mastermind monitors if either is getting neglected." },
  ...
  { question: "How does Kalnehi Daily help Class 12 students manage time?", answer: "Kalnehi Daily's daily planner helps you allocate specific time blocks each day for each subject — Physics, Chemistry, Maths for science stream; or Economics, Accountancy, Business Studies for commerce. You track completion daily so nothing accumulates into an overwhelming backlog." },
  { question: "Should I follow a fixed timetable for Class 12 Boards?", answer: "A fixed timetable often breaks by week 3. Kalnehi Daily uses a flexible system — you plan each day the evening before, logging what you'll study, then mark completion. This is more sustainable over 6-8 months of Board prep than a rigid schedule." },
];
        ...
        <section className="space-y-3" aria-labelledby="cbse12-system">
          ...
          <ul className="space-y-3 text-sm">
            {[
              ...
              { t: "Boards + entrance prep balance", d: "Set up separate exam goals for Boards and your entrance exam. Kalnehi Daily's daily planner lets you allocate specific time for each. Mastermind monitors the balance and flags when entrance prep is eating into Boards time." },
              ...
              { t: "Previous year paper practice tracking", d: "CBSE rewards students who practise previous year question papers. Log your PYQ practice sessions as daily tasks in Kalnehi Daily and track which subjects still need paper practice." },
            ].map(({ t, d }) => (
