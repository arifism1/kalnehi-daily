      ...
      <article className="space-y-10">
        ...
        <section className="space-y-3" aria-labelledby="cbse12-system">
          ...
          <ul className="space-y-3 text-sm">
            {[
              { t: "Subject-wise syllabus tracker", d: "Track chapters across Physics, Chemistry, Maths (or Biology) at the topic level. Mark NCERT chapters as done and flag chapters that need revision. PrepBrain monitors your completion per subject." },
              { t: "Boards + entrance prep balance", d: "Set up separate exam goals for Boards and your entrance exam. Kalnehi's daily planner lets you allocate specific time for each. PrepBrain monitors the balance and flags when entrance prep is eating into Boards time." },
              { t: "Exam countdown", d: "Track exactly how many days until your Board exams start. PrepBrain uses this to plan backward — telling you how many chapters to cover per week to finish the syllabus before revision month." },
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your Class 12 Board prep system" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
