      ...
      <MarketingPageJsonLd
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "You can start with a 3-day paid trial from the pricing page, then continue monthly if it fits. Basic tier includes a small trial gift of photo scans and voice minutes during the trial.",
          },
          {
