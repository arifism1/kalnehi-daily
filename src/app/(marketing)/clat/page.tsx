...
export const metadata = marketingPageMetadata({
  ...
  description: `CLAT has 5 sections — English, Current Affairs, Legal Reasoning, Logical Reasoning and Quantitative Techniques. Kalnehi tracks your section-wise progress and PrepBrain AI identifies your score gaps.`,
});
...
const FAQS = [
  ...
  { question: "Does Kalnehi help with CLAT reading comprehension practice?", answer: "Kalnehi tracks your daily practice sessions — including RC passages, legal reasoning sets and logical reasoning. Log each day's practice and PrepBrain monitors your consistency to ensure you're not skipping any section for weeks." },
  { question: "How does PrepBrain AI help CLAT aspirants?", answer: "PrepBrain reads your mock test data across all 5 sections and tells you which section is pulling your overall score down the most. It recommends reallocating daily study time to your weakest section until the next mock test." },
];
      ...
      <article className="space-y-10">
        ...
        <section className="space-y-4" aria-labelledby="clat-sections">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              { s: "English Language (20%)", tips: "2-3 RC passages daily. Track speed and accuracy separately. PrepBrain flags when your reading speed has plateaued." },
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your CLAT prep system" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
