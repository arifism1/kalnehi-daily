...
export const metadata = marketingPageMetadata({
  ...
  description: `CA Final is the last exam before you become a Chartered Accountant. 8 advanced papers, massive syllabuses, and articleship pressure. Kalnehi Daily tracks it all so nothing falls through.`,
});
...
const FAQS = [
  ...
  { question: "How does Kalnehi Daily help CA Final students during articleship?", answer: "CA Final is unique because most students prepare during a 3-year articleship with limited daily study time. Kalnehi Daily helps you extract maximum output from 3-4 hours per day — planning exactly which paper and which chapter to cover each day, and tracking progress so nothing slips for months at a time." },
  ...
  { question: "What is the CA Final pass rate?", answer: "CA Final both groups pass rate is around 10-15%. Single group pass rates are higher (20-25%). The exam is genuinely hard — but most failures are due to preparation imbalances across 8 papers, not intelligence. Kalnehi Daily's syllabus tracker prevents that." },
];
    ...
    <>
      ...
      <article className="space-y-10">
        <ExamHero
          ...
          subheadline="CA Final is 8 papers of advanced content, prepared during a 3-year articleship that leaves you with 3-4 hours per day at most. Every hour has to count. Kalnehi Daily makes sure they do."
        />
        ...
        <section className="space-y-2">
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li><Link href="/for/ca-students" className="font-medium text-kal-accent-dark hover:underline">Kalnehi Daily for CA Students →</Link></li>
          </ul>
        </section>
