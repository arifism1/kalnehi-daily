...
export const metadata = marketingPageMetadata({
  ...
  description: `The digital SAT has Reading & Writing and Math sections. Kalnehi helps you track your daily practice, log Khan Academy progress, and use PrepBrain AI to identify your score improvement areas.`,
});
...
const FAQS = [
  ...
  { question: "How does Kalnehi help SAT aspirants?", answer: "Track your daily Khan Academy practice sessions, full-length practice tests, and topic-wise completion in Kalnehi. PrepBrain reads your practice test scores and identifies which question types within Reading & Writing or Math are your weakest." },
];
  ...
  return (
    <>
      ...
      <article className="space-y-10">
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your SAT prep system" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
