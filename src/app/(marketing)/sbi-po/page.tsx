...
export const metadata = marketingPageMetadata({
  ...
  description: `SBI PO is one of India's most coveted banking jobs. Kalnehi tracks your preliminary and mains preparation, logs daily mock scores, and helps PrepBrain AI optimise your sectional strategy.`,
});
...
const FAQS = [
  ...
  { question: "How does Kalnehi help SBI PO aspirants?", answer: "Kalnehi tracks your prelims and mains preparation separately. Log daily mock tests across all sections. PrepBrain identifies which section is your weakest based on mock history and tells you how many focused hours that section needs before your exam date." },
  { question: "Can I prepare for SBI PO and IBPS PO at the same time?", answer: "Yes — and most serious banking aspirants do. The syllabuses overlap significantly. Kalnehi lets you track both exam dates and build a single preparation plan that covers both. PrepBrain monitors whether you're ready for the earlier exam date and alerts you if you're not." },
];
      ...
      <article className="space-y-10">
        ...
        <section className="space-y-3" aria-labelledby="sbipo-system">
          ...
          <ul className="space-y-3 text-sm">
            {[
              { t: "Prelims + Mains tracking", d: "Set up separate syllabus trackers for Prelims (QA, Reasoning, English) and Mains (Data Analysis, Reasoning + Computer, English, GA). PrepBrain monitors both phases and shifts focus as dates approach." },
              { t: "Mock test score logging", d: "Log each mock test score with section breakdowns. PrepBrain tracks your improvement curve across mocks and tells you when you've plateaued in a section and need to change your approach." },
              { t: "Descriptive paper practice", d: "SBI PO Mains has a 30-minute descriptive paper. Track your daily essay and letter writing practice as a separate habit — PrepBrain flags when you've gone a week without practice." },
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your SBI PO prep system" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
