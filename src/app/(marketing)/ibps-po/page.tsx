    ...
    <>
      ...
      <article className="space-y-10">
        ...
        <section className="space-y-4" aria-labelledby="ibps-sections">
          <h2 id="ibps-sections" className="text-xl font-semibold text-kal-text">IBPS PO sections tracked in Kalnehi Daily</h2>
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your IBPS PO prep system" subtext="7 days free. Mastermind. No credit card." />
      </article>
    </>
  );
}
