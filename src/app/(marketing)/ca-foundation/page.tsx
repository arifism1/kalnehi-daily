...
export const metadata = marketingPageMetadata({
  ...
  description: `CA Foundation has 4 papers — Accounts, Law, Maths and Economics. Kalnehi tracks your paper-wise syllabus, helps you plan daily study hours, and uses PrepBrain AI to identify your score gaps.`,
});
...
const FAQS = [
  ...
  { question: "How does Kalnehi track CA Foundation paper-wise progress?", answer: "Set up each paper as a subject in Kalnehi's syllabus tracker. Track chapters within each paper at the topic level. PrepBrain AI monitors which paper is most behind and tells you how many hours to shift to close the gap before your exam date." },
    ...
    <>
      ...
      <article className="space-y-10">
        ...
        <section className="space-y-3" aria-labelledby="cafound-prepbrain">
          <h2 id="cafound-prepbrain" className="text-xl font-bold text-kal-text">How PrepBrain AI helps CA Foundation students</h2>
          <p className="text-sm text-kal-text-secondary">PrepBrain tracks your ICAI mock scores and tells you which paper is pulling your aggregate down. It also flags when you're spending too many hours on Paper 1 (Accounts) while Paper 3 (Maths) is neglected — a common mistake that causes Foundation failures.</p>
        </section>
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Track all 4 CA Foundation papers in one place" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
