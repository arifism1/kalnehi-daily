  ...
  return (
    <>
      ...
      <article className="space-y-10">
        ...
        <FAQBlock items={FAQS} />
        <CTABanner headline="Build your NDA prep system" subtext="3 days free. PrepBrain AI. No credit card." />
      </article>
    </>
  );
}
