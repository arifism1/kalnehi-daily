...
const PATHS: { path: string; changeFrequency: "daily" | "weekly"; priority: number }[] = [
  ...
  { path: "/guides/how-to-maintain-consistency-in-jee-preparation", changeFrequency: "weekly", priority: 0.88 },
  { path: "/jee-study-planner", changeFrequency: "weekly", priority: 0.9 },
  { path: "/neet-study-planner", changeFrequency: "weekly", priority: 0.9 },
  { path: "/upsc-study-planner", changeFrequency: "weekly", priority: 0.9 },
  { path: "/boards-study-planner", changeFrequency: "weekly", priority: 0.85 },
  { path: "/brain-yoga", changeFrequency: "weekly", priority: 0.88 },
